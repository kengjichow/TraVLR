...
class SpatialDatasetGen:
    ...
    def gen_dataset(self, numConditions):
        ...
        for i in range(numConditions):
            ...
            relationship = random.choice(["left", "right", "top", "bottom"])
            correct = i%2
            condition = SpatialConditionGen(object_list, relationship, self.settings, image_gen).gen_condition(
                num_tokens_per_condition, correct)
